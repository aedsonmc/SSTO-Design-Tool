...
title({'Mass Flow Rate of Gases Through Engine Intakes vs Height', [num2str(vel), ' m/s']})
xlabel('Mass Flow Rate [kg/s]')
ylabel('Altitude [km]')
grid on
%% Pre-Cooler Heat Load %%
qdot = airmdot_tri.*1.15*(1000+150);

%%% Plotting
figure(3)
plot(qdot./10e5,alt./1000,'k','LineWidth',1.2)
ylabel('Altitude')
xlabel('Heat Load, GW')
title({'Precooler Heat Load, All Engines',[num2str(vel), ' m/s']})
grid on